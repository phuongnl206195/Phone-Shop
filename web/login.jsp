<%-- 
    Document   : login
    Created on : Jan 28, 2021, 7:57:45 PM
    ...
    <div class="wrapper">
      ...
      <div class="form-container">
        ...
        <div class="form-inner">
            ...
            <div class="field">
                <input value="${u}" name="username" type="text" placeholder="UserName" required>
            </div>
            <div class="field">
                <input name="pass" type="password" placeholder="Password" required>
            </div>
            <div class="pass-link"><a href="forgot.jsp">Forgot password?</a></div>
            <div class="pass-link"><a href="question.jsp">Security Question</a></div>
            <div class="field btn">
